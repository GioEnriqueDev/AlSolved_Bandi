...
const defaultOptions: HyperspeedOptions = {
    ...
    colors: {
        roadColor: 0xf1f5f9,      // Slate 100
        islandColor: 0xffffff,    // White Island
        background: 0xf8fafc,     // Slate 50 (Page Background)
        shoulderLines: 0xff2e63,  // AlSolved Pink
        brokenLines: 0xff2e63,    // AlSolved Pink
        leftCars: [0xff2e63, 0xff5e8a, 0xff0044],  // Shades of Pink/Red
        rightCars: [0x64748b, 0x94a3b8, 0xcbd5e1], // Slate shades
        sticks: 0xff2e63          // Pink sticks
    }
};
...
class App {
    ...
    constructor(container: HTMLElement, options: HyperspeedOptions) {
        ...
        this.camera.position.y = 7; // Lowered slightly for better centering
    ...
    initPasses() {
        ...
        this.bloomPass = new EffectPass(
            ...
            new BloomEffect({
                ...
                resolutionScale: 0.5 // Optimized for performance
            })
        );
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
    ...
    return <div className="absolute inset-0 w-full h-full -z-10" ref={hyperspeed}></div>;
};
